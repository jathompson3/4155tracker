...
class DBHandler  // creating a constructor for our database handler.
    ...
    companion object {
        ...
        // below variable id for our user email column.
        private const val EMAIL_COL = "email"

        // below variable for our user password column.
        private const val PASSWORD_COL = "password"

        // below variable for our user confirm password column.
        private const val CONFIRMPASSWORD_COL = "password"
    }
}